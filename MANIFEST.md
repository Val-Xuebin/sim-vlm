...
- `src/vlm_sim/actions.py`: action catalog, dynamic capability checks, visual-target grounding, and parameter sanitization.
...
- `tests/test_actions.py`: object grounding, availability, invalid-target, and parameter tests.
